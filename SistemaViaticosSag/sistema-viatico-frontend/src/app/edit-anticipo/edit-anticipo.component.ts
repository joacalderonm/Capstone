...
@Component({
  ...
  templateUrl: './edit-anticipo.component.html',
  styleUrl: './edit-anticipo.component.css'
})
export class EditAnticipoComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<EditAnticipoComponent>,
    private apiService: ApiService,
    @Inject(MAT_DIALOG_DATA) public data: { anticipo: AnticipoEditForm }
  ) {}

  ngOnInit(): void {
    this.tituloFormulario = this.data.anticipo.titulo_formulario;
    this.initForm();
    this.cargarUnidades();
  ...
  private populateForm(): void {
    ...
    this.anticipoForm.patchValue({
      unidad: anticipo.id_unidad,
      programa: anticipo.id_programa,
      cuentaPresupuestaria: anticipo.id_cuenta_presupuestaria,
      motivoCometido: anticipo.id_motivo_cometido,
      region: anticipo.id_region,
      productoSubesp: anticipo.id_producto_subesp,
      localidadDestino: anticipo.localidad_destino,
      fechaDesde: anticipo.fecha_desde,
      fechaHasta: anticipo.fecha_hasta,
      dias100: anticipo.dias_100,
      dias40: anticipo.dias_40,
      descripcionCometido: anticipo.descripcion_cometido,
  ...
  guardarAnticipo(): void {
    if (this.anticipoForm.valid) {
      const datos = { ...this.anticipoForm.value };
